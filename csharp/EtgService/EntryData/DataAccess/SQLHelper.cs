...
namespace Etg.Data.Entry
{
    ...
    {
        public static string strConnect = "";// System.Configuration.ConfigurationManager.ConnectionStrings["DbConn"].ConnectionString;//SysConfig.SqlConnect;
        ...
        public static int RunProcedureExecuteNonQuery(string strSQL, object param)
        {

            return DbHelper.RunProcedureExecuteNonQuery(strConnect, strSQL, param);
        ...
        /// <param name="strSQL">执行的SQL语句</param>
        /// <returns>影响行数</returns>
        public static int RunProcedureExecuteNonQuery(string strSQL)
        {
            return RunProcedureExecuteNonQuery(strSQL, null);
        }
