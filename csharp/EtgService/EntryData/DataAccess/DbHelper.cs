...
namespace Etg.Data.Entry
{
    internal static class DbHelper
    {
        ...
        internal static DataTable RunSQL(string strCon, string procName, object param)
        {
        ...
        internal static int RunProcedureExecuteNonQuery(string strCon, string strSQL, object param)
        {
            using (SqlConnection con = new SqlConnection(strCon))
            {
                if (con.State != ConnectionState.Open)
